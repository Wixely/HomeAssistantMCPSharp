...
HomeAssistantMCPSharp is licensed under the MIT License (see `LICENSE`). It
...
"Home Assistant" is a trademark of Nabu Casa, Inc. Use of the name in this
project does not imply endorsement by, or affiliation with, Nabu Casa.
